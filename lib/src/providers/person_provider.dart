...
////////////////////////////////////////////////////////////////////////////////
  Future<bool> createPerson(PersonModel person) async {
    // final url = '$_url/vecino.json?auth=${_prefs.token}';
    final url = '$_url/vecino.json';
    final answer = await http.post(url, body: personModelToJson(person));
...
////////////////////////////////////////////////////////////////////////////////
  Future<bool> modifyPerson(PersonModel person) async {
    // final url = '$_url/vecino/${person.id}.json?auth=${_prefs.token}';
    final url = '$_url/vecino/${person.id}.json';
    final answer = await http.put(url, body: personModelToJson(person));
...
////////////////////////////////////////////////////////////////////////////////
  Future<List<PersonModel>> loadPerson() async {
    // final url = '$_url/vecino.json?auth=${_prefs.token}';
    final url = '$_url/vecino.json';
    ...
    final List<PersonModel> persons = new List();

    if (decodedData == null) return [];

    //**Se recorre cada posición
    decodedData.forEach((id, personDecoded) {
      final personTemp = PersonModel.fromJson(personDecoded);
      personTemp.id = id;
...
////////////////////////////////////////////////////////////////////////////////
  Future<int> deletePerson(String id) async {
    // final url = '$_url/vecino/$id.json?auth=${_prefs.token}';
    final url = '$_url/vecino/$id.json';
